	...
	case "Budget":
		...
		switch(KondisiKendaraan) {
			case "New":
				...
				switch(Simulasi) {
					...
					case "Angsuran":
						...
						switch(LoanType) {
							case "ADDM":
								String BayarPertama = MukaAngsuran1
								Mobile.tap(findTestObject('Object Repository/xpath', ['xpath' : "//*[@resource-id = '$id/et_simulasi_uang_muka']"]), 0)
								...
								break;
							case "ADDB":
								String BayarPertama = BelakangAngsuran1
								Mobile.tap(findTestObject('Object Repository/xpath', ['xpath' : "//*[@resource-id = '$id/et_simulasi_uang_muka']"]), 0)
				...
				Mobile.hideKeyboard()
				Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathBudget)) + '/' + Simulasi + '/' + No + '/'  + 'Tenor1' + '/' + 'New_Car') + '.png', FailureHandling.STOP_ON_FAILURE)
			...
			case "Used":
				 ...
				 Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathBudget)) + '/' + Simulasi + '/' + No + '/'  + 'Tenor1' + '/' + 'Used_Car') + '.png', FailureHandling.STOP_ON_FAILURE)
		...
		// Halaman Tenor
		Mobile.callTestCase(findTestCase('Test Cases/Simulasi_Budget/HasilHitungan/AngsuranMuka1'), ['No' : No, 'Simulasi' : Simulasi ], null)
		Mobile.callTestCase(findTestCase('Test Cases/Simulasi_Budget/HasilHitungan/AngsuranBelakang1'), ['No' : No, 'Simulasi' : Simulasi ], null)
