	...
	case "Budget":
		...
		switch(KondisiKendaraan) {
			case "New":
				...
				switch(Simulasi) {
					...
					case "Bayar Pertama":
						...
						switch(LoanType) {
							case "ADDM":
								...
								break;
							case "ADDB":
								String BayarPertama = BelakangDP3
								Mobile.tap(findTestObject('Object Repository/xpath', ['xpath' : "//*[@resource-id = '$id/et_simulasi_uang_muka']"]), 0)
					...
					case "Angsuran":
						...
						switch(LoanType) {
							case "ADDM":
								String BayarPertama = MukaAngsuran3
								Mobile.tap(findTestObject('Object Repository/xpath', ['xpath' : "//*[@resource-id = '$id/et_simulasi_uang_muka']"]), 0)
								...
								break;
							case "ADDB":
								String BayarPertama = BelakangAngsuran3
								Mobile.tap(findTestObject('Object Repository/xpath', ['xpath' : "//*[@resource-id = '$id/et_simulasi_uang_muka']"]), 0)
				...
				Mobile.hideKeyboard()
				Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathBudget)) + '/' + Simulasi + '/' + No + '/'  + 'Tenor3' + '/' + 'New_Car') + '.png', FailureHandling.STOP_ON_FAILURE)
			...
			case "Used":
				 ...
				 Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathBudget)) + '/' + Simulasi + '/' + No + '/'  + 'Tenor3' + '/' + 'Used_Car') + '.png', FailureHandling.STOP_ON_FAILURE)
