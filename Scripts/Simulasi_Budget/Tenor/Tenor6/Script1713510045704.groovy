	...
	case "Budget":
		...
		switch(KondisiKendaraan) {
			case "New":
				...
				switch(Simulasi) {
					...
					case "Bayar Pertama":
						...
						switch(LoanType) {
							case "ADDM":
								...
								break;
							case "ADDB":
								String BayarPertama = BelakangDP6
								Mobile.tap(findTestObject('Object Repository/xpath', ['xpath' : "//*[@resource-id = '$id/et_simulasi_uang_muka']"]), 0)
					...
					case "Angsuran":
						...
						switch(LoanType) {
							case "ADDM":
								String BayarPertama = MukaAngsuran6
								Mobile.tap(findTestObject('Object Repository/xpath', ['xpath' : "//*[@resource-id = '$id/et_simulasi_uang_muka']"]), 0)
								...
								break;
							case "ADDB":
								String BayarPertama = BelakangAngsuran6
								Mobile.tap(findTestObject('Object Repository/xpath', ['xpath' : "//*[@resource-id = '$id/et_simulasi_uang_muka']"]), 0)
				...
				Mobile.hideKeyboard()
				Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathBudget)) + '/' + Simulasi + '/' + No + '/'  + 'Tenor6' + '/' + 'New_Car') + '.png', FailureHandling.STOP_ON_FAILURE)
			...
			case "Used":
				 ...
				 Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathBudget)) + '/' + Simulasi + '/' + No + '/'  + 'Tenor6' + '/' + 'Used_Car') + '.png', FailureHandling.STOP_ON_FAILURE)
		...
		// Halaman Tenor
		Mobile.callTestCase(findTestCase('Test Cases/Simulasi_Budget/HasilHitungan/AngsuranMuka6'), ['No' : No, 'Simulasi' : Simulasi ], null)
		Mobile.callTestCase(findTestCase('Test Cases/Simulasi_Budget/HasilHitungan/AngsuranBelakang6'), ['No' : No, 'Simulasi' : Simulasi ], null)
