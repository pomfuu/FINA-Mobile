...
Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathBudget)) + '/' + Simulasi + '/' + No + '/'  + 'Tenor1' + '/' + 'Angsuran_Belakang' + '/' + 'AngsuranBelakangResult' ) + '.png', FailureHandling.STOP_ON_FAILURE)
...
if (Mobile.verifyElementExist(testObject, 2, FailureHandling.OPTIONAL)) {
	...
	for(int i = 1; i <= 6;i++) {
		...
		Mobile.delay(1)
		Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathBudget)) + '/' + Simulasi + '/' + No + '/'  + 'Tenor1' + '/' + 'Angsuran_Belakang' + '/' + i + ' tahun' ) + '.png', FailureHandling.STOP_ON_FAILURE)
		Mobile.delay(1)
