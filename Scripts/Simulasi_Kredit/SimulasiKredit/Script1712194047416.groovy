...
switch(JenisSimulasi) {
	case "Kredit":
		...
		Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathKredit)) + '/' + 'Simulasi_Kredit') + '.png', FailureHandling.STOP_ON_FAILURE)
		...
		switch(KondisiKendaraan) {
			case "New":
				...
				Mobile.hideKeyboard()
				Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathKredit)) + '/' + No + '/' + 'New_Car') + '.png', FailureHandling.STOP_ON_FAILURE)
			...
			case "Used":
				 ...
				 Mobile.takeScreenshot((((baseDir + GlobalVariable.screenshotPathKredit)) + '/' + No + '/' + 'Used_Car') + '.png', FailureHandling.STOP_ON_FAILURE)
		...
		// Halaman Tenor
		Mobile.callTestCase(findTestCase('Test Cases/Simulasi_Kredit/HasilHitungan/AngsuranMuka'), 
			['No': No ], 
			FailureHandling.STOP_ON_FAILURE)		
		Mobile.callTestCase(findTestCase('Test Cases/Simulasi_Kredit/HasilHitungan/AngsuranBelakang'), ['No': No, 'KondisiKendaraan': KondisiKendaraan ], FailureHandling.STOP_ON_FAILURE)
