...
// Halaman Tenor
Mobile.callTestCase(findTestCase('Test Cases/Simulasi_MiniMax/HasilHitungan/AngsuranMuka'), null)
Mobile.callTestCase(findTestCase('Test Cases/Simulasi_MiniMax/HasilHitungan/AngsuranBelakang'), null)
